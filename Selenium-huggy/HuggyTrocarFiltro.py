...
class ChromeAutenticao:
    ...
    def Trocar_Flow(self): # FUNÇÃO PARA INCIAR A TROCA DO FLOW
...
################################################# SESSÃO DENTRO DO HUGGY, ACESSANDO ATÉ A TROCA DO FLOW ##################################################
        ...
        time.sleep(2) # ESPERA 2 SEGUNDOS ANTES DE CLILCAR EM CONFIGURAÇÕES
        self.driver.find_element(By.CLASS_NAME, "aside-badge contacts-counter badge_BlGb1").click()      # CLICAR EM CONFIGURAÇÕES
        time.sleep(1) # ESPERA 1 SEGUNDOS ANTES DE CLILCAR EM CANAIS
        self.driver.find_element(By.LINK_TEXT, "Canais").click()     # CLILCAR EM CANAIS   
        time.sleep(1) # ESPERA 1 SEGUNDOS ANTES DE CLILCAR EM WHATS BUSINESS API
        ...
        time.sleep(1) # ESPERA 1 SEGUNDOS ANTES DE CLILCAR NO INPUT A SENHA
        self.driver.find_element(By.CSS_SELECTOR, ".form-item:nth-child(9) li:nth-child(22) > label").click()    # CLICAR NO FLOW: saida_JV
...
bot.Trocar_Flow() # INSTANCIAR A FUNÇÃO DENTRO DA CLASSE
