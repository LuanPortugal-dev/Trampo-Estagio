...
################################################## SESSÃO DE LOGIN #######################################################################################
        ...
        self.driver.find_element(By.ID, "input_17").send_keys("aaaaaaadddddaaaaa") # COLOCAR A SENHA NO INPUT SENHA
        time.sleep(1) # ESPERA 1 SEGUNDOS ANTES DE CLILCAR NO INPUT A SENHA
...
################################################# SESSÃO DENTRO DO HUGGY, ACESSANDO ATÉ A TROCA DO FLOW ##################################################
        ...
        time.sleep(2) # ESPERA 2 SEGUNDOS ANTES DE CLILCAR EM WHATS VERIFICADO
        self.driver.switch_to.frame(1)
        self.driver.find_element(By.CLASS_NAME, "htable-column-label").click()    # CLICAR EM WHATS VERIFICADO
        time.sleep(1) # ESPERA 1 SEGUNDOS ANTES DE CLILCAR NO SELECIONE FLOW
